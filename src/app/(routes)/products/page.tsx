...
const Products = ({ searchParams }: Props) => {
  ...
  return (
    <main className='size-full flex flex-col justify-between'>
      <ProductsNavbar />
      <section className='flex justify-center items-center flex-1 overflow-y-auto pt-3 px-3'>
        {products.length > 0 ? (
          <div className='w-full max-w-[1220px] gap-y-4 gap-x-1 items-center h-fit min-h-full grid grid-cols-[repeat(auto-fill,_minmax(288px,1fr))] grid-rows-2 justify-center justify-items-center align-items-center'>
